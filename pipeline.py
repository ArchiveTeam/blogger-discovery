...
project = Project(
    title="Blogger Discovery",
    project_html="""
        <img class="project-logo" alt="Project logo" src="http://archiveteam.org/images/6/64/Blogger-logo.png" height="50px" title=""/>
        <h2>Blogger Phase 1.
        <span class="links">
             <a href="http://www.blogger.com/">Website</a> &middot;
             <a href="http://tracker.archiveteam.org/bloggerdisco/">Leaderboard</a>
             <a href="http://archiveteam.org/index.php?title=Blogger">Wiki</a> &middot;
         </span>
        </h2>

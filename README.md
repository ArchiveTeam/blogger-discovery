blogger-discovery-grab
=======================

More information about the archiving project can be found on the ArchiveTeam wiki: [Blogger](http://archiveteam.org/index.php?title=Blogger)
...
Follow the [instructions on the ArchiveTeam wiki](http://archiveteam.org/index.php?title=Warrior) for installing the Warrior, and select the "Blogger" project in the Warrior interface.
...
6. `screen su -c "cd /home/archiveteam/blogger-discovery/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam`
...
Have an issue not listed here? Join us on IRC and ask! We can be found at irc.efnet.org #frogger.
